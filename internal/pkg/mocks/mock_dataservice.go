...
// Source: internal/app/dataservice/dataservice.go
//
// Generated by this command:
//
//	mockgen -package=mocks -source=internal/app/dataservice/dataservice.go -destination=internal/pkg/mocks/mock_dataservice.go
//
...
import (
	model "auth-service/internal/app/model"
	context "context"
...
func (m *MockResetTokenInterface) Create(newResetToken *model.ResetToken) error {
	m.ctrl.T.Helper()
...
func (m *MockResetTokenInterface) Delete(condition map[string]any) error {
	m.ctrl.T.Helper()
...
func (m *MockResetTokenInterface) Get(condition map[string]any) (*model.ResetToken, error) {
	m.ctrl.T.Helper()
...
// Delete mocks base method.
func (m *MockVerificationTokenInterface) Delete(condition map[string]any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", condition)
	ret0, _ := ret[0].(error)
	return ret0
...
// Get mocks base method.
func (m *MockVerificationTokenInterface) Get(condition map[string]any) (*model.VerificationToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", condition)
...
// Create mocks base method.
func (m *MockSessionInterface) Create(ctx context.Context, userId string) (*model.Session, error) {
	m.ctrl.T.Helper()
...
// Delete mocks base method.
func (m *MockSessionInterface) Delete(ctx context.Context, sessionId string) error {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockSessionInterface) Get(ctx context.Context, sessionId string) (*model.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockSessionInterface) Update(ctx context.Context, sessionId string) (*string, *model.Session, error) {
	m.ctrl.T.Helper()
